...
<body>
            ...
            <div class="row g-5">
                <div class="col-lg-12">
                    ...
                    <div class="section-body mb-2">
                        <div class="col-lg-12">
                            <div class="row">
                                <form action="{{ route('account.update', ['account' => $account['userID']]) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group"
                                                ...
                                                <label for="firstName" style="margin-bottom: 5px;"><b>First
                                                        Name:</b></label>
                                                <input class="form-control" required type="text" name="firstName"
                                                    id="" style="margin-bottom: 5px;"
                                                    value="{{ $account['firstName'] }}">

                                            </div>
                                            <div class="form-group"
                                                style="width: 250px; margin-right: 20px;float: left;">
                                                <label for="middleName" style="margin-bottom: 5px;"><b>Middle
                                                        Name:</b></label>
                                                <input type="text" class="form-control" name="middleName"
                                                    style="margin-bottom: 5px;" value="{{ $account['middleName'] }}">
                                            </div>
                                            <div class="form-group"
                                                style="width: 250px; margin-right: 20px;float: left;">
                                                <label for="lastName" style="margin-bottom: 5px;"><b>Last
                                                        Name:</b></label>
                                                <input required type="text" class="form-control" name="lastName"
                                                    style="margin-bottom: 5px;" value="{{ $account['lastName'] }}">
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group"
                                                style="width: 250px; margin-right: 20px;float: left;">
                                                <label for="address"
                                                    style="margin-bottom: 5px;"><b>Address:</b></label>
                                                <br>
                                                <textarea name="address" id="" cols="40" rows="2" style="margin-bottom: 5px;">{{ $account['address'] }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group"
                                                style="width: 250px; margin-right: 20px;float: left;">
                                                <label for="birthDate" style="margin-bottom: 5px;"><b>Birth
                                                        Date:</b></label>
                                                <input required type="date" class="form-control" name="birthDate"
                                                    style="margin-bottom: 5px;" value="{{ $account['birthDate'] }}">
                                            </div>
                                            <div class="form-group"
                                                style="width: 250px; margin-right: 20px;float: left;">
                                                <label for="phoneNumber" style="margin-bottom: 5px;"><b>Phone
                                                        Number:</b></label>
                                                <input required type="number" class="form-control"
                                                    name="phoneNumber" style="margin-bottom: 5px;"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group"
                                                style="width: 250px; margin-right: 20px;float: left;">
                                                <label for="email"
                                                    style="margin-bottom: 5px;"><b>Email:</b></label>
                                                <input required type="email" class="form-control" name="email"
                                                    style="margin-bottom: 5px;" value="{{ $account['email'] }}">
                                            </div>
                                            <div class="form-group"
                                                style="width: 250px; margin-right: 20px;float: left;">
                                                <label for="password" style="margin-bottom: 5px;"><b>Change
                                                        Password:</b></label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary"
                                                    name="btnUpdateAccount" value="yes">Update</button>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
        ...
        <script>
            setTimeout(() => {
                Swal.fire({
                    position: 'center',
                    icon: 'warning',
                    title: 'Failed To Update Account, Please try again later',
                    showConfirmButton: false,
                    timer: 800
                });
            }, 500);
    ...
    @if (session()->pull('phoneNumberLengthErr'))
        <script>
            setTimeout(() => {
                Swal.fire({
                    position: 'center',
                    icon: 'warning',
                    title: 'Phone Number Length Is More Than 13 Characters',
                    showConfirmButton: false,
                    timer: 1000
                });
            }, 500);
        </script>
        {{ session()->forget('phoneNumberLengthErr') }}
    @endif
